...
export async function Code({ children, lang = "typescript" }: CodeProps) {
  ...
  return (
    <div className="group relative my-4 rounded-lg border border-neutral-200 bg-neutral-50 text-[13px] font-mono overflow-hidden max-w-full dark:border-neutral-800 dark:bg-neutral-900">
      <div
